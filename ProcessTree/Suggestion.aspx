                      ...
                      <table class="table">
                        ...
                        <asp:Label ID="LabelBalance" runat="server" CssClass="balance"></asp:Label>
                                                          ...
                                                          <td class="auto-style24">
                                                                                                  <asp:Button ID="BtnHistory" runat="server" OnClick="BtnHistory_Click" Text="Versions History" TabIndex="9" Width="158px" />                       
                        ...
                        function period_check() {
                            ...
                            xmlhttp.onreadystatechange = function () {
                                if (xmlhttp.readyState == XMLHttpRequest.DONE) {   // XMLHttpRequest.DONE == 4
                                    if (xmlhttp.status == 200 || xmlhttp.status == 0 || xmlhttp.status == 404) {
        ...
        <table class="auto-style25" >
            <tr>
                <td class="auto-style26">
                                ...
                                <asp:Button ID="BtnSubmit" runat="server" Font-Bold="True" onclick="BtnSubmit_Click" TabIndex="3" Text="Submit Suggestion" AccessKey="s"/>
                            <br />
                </td>
