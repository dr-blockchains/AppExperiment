<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Trading.aspx.cs" Inherits="ProcessTree.Trading" MaintainScrollPositionOnPostBack = "true" %>
...
<body >
    <form id="Trading" runat="server" class="auto-style41">
            ...
            <tr>
                ...
                <td class="auto-style37" colspan="2">    
                    ...
                    <asp:Label ID="Message" runat="server" Font-Bold="True" ForeColor="#993333" CssClass="auto-style1" Font-Size="Medium" Height="28px" style="font-size: medium" Font-Italic="True" Width="132%"></asp:Label>
                </td>
               
                <td class="auto-style61">    
                    <span class="auto-style62"><em>Refresh to see the new offers: </em></span>&nbsp;</td>
            ...
            <tr>   
                <td class="auto-style53" colspan="2">    
                    ...
                    &nbsp; Amount = <asp:TextBox ID="TotalVol" runat="server" BackColor="#FFAAAA" TabIndex="30" Width="99px" Font-Bold="True" Height="25px"></asp:TextBox>
                    &nbsp;shares
                ...
                <td class="auto-style48" colspan="2">    
                    ...
                    Your available Shares for this choice =
                                              <asp:Label ID="Shares" runat="server" Class="balance" Font-Bold="True" Font-Size="Medium"></asp:Label>  
            ...
            <tr>
                ...
                <td class="auto-style53" colspan="2">    
                    ...
                    Price 
                    <asp:Label ID="Than" runat="server" Text="&gt;"></asp:Label>
                    =&nbsp;<asp:TextBox ID="Price" runat="server" BackColor="#FFAAAA" TabIndex="40" Width="99px" Font-Bold="True" Height="25px"></asp:TextBox>

                    &nbsp;dollars</td>
               
                <td class="auto-style48" colspan="2">    
    
                    Your available Balance for this choice = $ <asp:Label ID="Balance" runat="server" Class="balance" Font-Bold="True" Font-Size="Medium"></asp:Label>                                  
            ...
            <tr>               
                ...
                <td class="auto-style48" colspan="2">        
                    <asp:Button ID="AutoFill" runat="server" Font-Bold="False" onclick="AutoFill_Click" TabIndex="50" Text="Suggest Numbers" CssClass="text-center" Font-Size="Small" BackColor="#66FF66" ForeColor="Black" Height="32px" Width="174px" />                                   
                    </td>
            </tr>                    
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style48" colspan="2">    
                    <em>Your open orders for this choice:</em></td>
            </tr>                    
            <tr>
               
                <td class="auto-style54">    
    
                    <asp:ListBox ID="ListBox1" runat="server" BackColor="#66FF66" DataSourceID="SqlDataSource6" DataTextField="Content" DataValueField="Time" Width="250px"></asp:ListBox>
                      </td>
               
                <td class="auto-style55">    
    
                    <asp:ListBox ID="ListBox2" runat="server" BackColor="#FFAAAA" DataSourceID="SqlDataSource5" DataTextField="Content" DataValueField="Time" Width="250px"></asp:ListBox>

                </td>
               
                <td class="text-center" colspan="2">    
                    <asp:ListBox ID="SelfOrders" runat="server" BackColor="#99CCFF" DataSourceID="SqlDataSource4" DataTextField="Content" DataValueField="Time" Width="270px" TabIndex="70"></asp:ListBox>
                    <asp:Button ID="Delete" runat="server" Font-Bold="False" onclick="Delete_Click" TabIndex="80" Text="Cancel this Order" CssClass="text-center" Font-Size="Small" BackColor="#CCCCCC" ForeColor="#660066" />
            ...
            <tr>
                ...
                <td class="text-left" colspan="3">    
                    ...
                    <asp:Label ID="LastPrice" runat="server" BackColor="Yellow" BorderStyle="Solid" Font-Bold="False" Text="N/A" BorderColor="#FFCC00" BorderWidth="3px"></asp:Label>
                </td>
                ...
                <td class="style2" colspan="2">
                    ...
                    <span class="auto-style59">Unavailable funds due to your offers on this choice = $ </span> <asp:Label ID="Offers" runat="server" Class="balance" Font-Bold="False" Font-Size="Small" CssClass="auto-style59">0.00</asp:Label>                                  
                ...
                <td class="style2" colspan="2">
                    ...
                    <span class="auto-style59">Unavailable funds due to your offer on other choices = $ </span> <asp:Label ID="OtherOffers" runat="server" Class="balance" Font-Bold="False" Font-Size="Small" CssClass="auto-style59">0</asp:Label>                                  
                    </table>           
    <script>
        ...
        Array.from(document.getElementsByClassName("version-artifact")).map(function (e) { e.addEventListener("mouseout", VersionArtifactMouseOut); });
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                        ...
                        SelectCommand="SELECT (CASE WHEN Buy0Sell1 = 0 THEN 'Buy ' ELSE 'Sell ' END) + CAST(UnFullfilled AS VARCHAR(MAX)) + ' shares at $' + CAST(Price AS VARCHAR(MAX)) AS Content, 
Time
FROM Offers 
WHERE (Treatment = @Treatment) AND ([Group#] = @Group) AND (Period = @Period) AND (Choice = @Choice) AND (Bidder = @Bidder) AND Unfullfilled &gt; 0 

ORDER BY Buy0Sell1, Time">
                        <SelectParameters>
                            ...
                            <asp:Parameter DefaultValue="" Name="Bidder" />
                        </SelectParameters>
                    </asp:SqlDataSource>
    
                    <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ProcessTreeConnectionString %>" 
                        SelectCommand="SELECT CAST(UnFullfilled AS VARCHAR(MAX)) + ' shares at $' + CAST(Price AS VARCHAR(MAX)) AS Content, Time 
FROM Offers 
WHERE (Treatment = @Treatment) AND ([Group#] = @Group) AND (Period = @Period) AND (Choice = @Choice) AND (Buy0Sell1 = 1) AND Unfullfilled &gt; 0 
...
ORDER BY Price ASC, Time ASC">
                        <SelectParameters>
                            ...
                            <asp:Parameter DefaultValue="1" Name="Group" />
                            <asp:Parameter DefaultValue="0" Name="Period" />
<asp:Parameter DefaultValue="0" Name="Choice"></asp:Parameter>
                        </SelectParameters>
                    </asp:SqlDataSource>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ProcessTreeConnectionString %>" 
                        SelectCommand="SELECT CAST(UnFullfilled AS VARCHAR(MAX)) + ' shares at $' + CAST(Price AS VARCHAR(MAX)) AS Content, 
Time
FROM Offers 
WHERE (Treatment = @Treatment) AND ([Group#] = @Group) AND (Period = @Period) AND (Choice = @Choice) AND (Buy0Sell1 = 0) AND Unfullfilled &gt; 0 
